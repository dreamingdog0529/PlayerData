# Contributing Guide For PlayerData
...
Use [GitHub Issues](https://github.com/dreamingdog0529/PlayerData/issues) with the YAML forms:
...
- [ ] Tests pass (`dotnet test PlayerData.slnx` / `task test`)
